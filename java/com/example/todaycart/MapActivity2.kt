...
class MapActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (location) {
            "과자1-1" -> btnDrink.setBackgroundColor(Color.rgb(180, 156, 246))
            "음료" -> btnJuice.setBackgroundColor(Color.rgb(255,162,239))
            "주류" -> btnCook3.setBackgroundColor(Color.rgb(255,162,239))
            "생활용품" -> btnCook3.setBackgroundColor(Color.rgb(255,162,239))
        }
